package net.nemerosa.iteach.repository;

import net.nemerosa.iteach.IteachApp;
import net.nemerosa.iteach.config.Constants;
import net.nemerosa.iteach.config.TestSecurityConfiguration;
import net.nemerosa.iteach.config.audit.AuditEventConverter;
import net.nemerosa.iteach.domain.PersistentAuditEvent;
...
import static net.nemerosa.iteach.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
